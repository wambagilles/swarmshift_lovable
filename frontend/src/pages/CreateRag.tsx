...
import { Upload, Link2, FileText, ArrowLeft, Bot, Sparkles, HelpCircle, Settings } from 'lucide-react';
...
const CreateRag: React.FC<CreateRagProps> = ({ onNavigate }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Simulate RAG creation
    setTimeout(() => {
      setIsLoading(false);
      // Navigate to chat with new RAG ID
      onNavigate('chat/new');
    }, 2000);
  };
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center gap-4 py-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-lg font-semibold text-foreground">{t('createAgent.title')}</h1>
                  <p className="text-sm text-muted-foreground">{t('createAgent.subtitle')}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <Card className="border-border">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                {t('createAgent.basicInfo')}
              </CardTitle>
              <CardDescription>
                {t('createAgent.basicInfoDesc')}
              </CardDescription>
            </CardHeader>
          ...
          <Card className="border-border">
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                {t('createAgent.modelConfig')}
              </CardTitle>
              <CardDescription>
                {t('createAgent.modelConfigDesc')}
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
          ...
          <div className="flex justify-end gap-4">
            ...
            <Button
              ...
              className="min-w-32"
            >
              {isLoading ? t('createAgent.creating') : t('createAgent.createAgent')}
            </Button>
          </div>
        </form>
      </div>
